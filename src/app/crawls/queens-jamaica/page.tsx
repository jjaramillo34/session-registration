...
const LOCATIONS = [
  {
    name: 'Hillcrest HS',
    programs: ['LYFE Program'],
    address: '160-05 Highland Ave',
    city: 'Queens',
    zip: '11432',
    coordinates: [-73.7984, 40.7089] as [number, number]
  },
  {
    name: 'Jamaica Learning Center',
    programs: ['Pathways to Graduation'],
    address: '162-02 Hillside Ave',
    city: 'Queens',
    zip: '11432',
    coordinates: [-73.7967, 40.7082] as [number, number]
  }
];

export default function QueensJamaicaPage() {
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                ...
                <div className="prose dark:prose-invert">
                  <p className="text-blue-600 dark:text-blue-400">
                    Explore our Queens Jamaica locations with this walking tour.
                    Visit two of our facilities and learn about the various programs we
                    offer in the Jamaica area.
                  </p>
                  ...
                  <ul className="list-none space-y-3">
                    ...
                    <li className="flex items-center gap-3 text-blue-600 dark:text-blue-400">
                      ...
                      <span>Learn about our LYFE Program</span>
                    </li>
                    <li className="flex items-center gap-3 text-blue-600 dark:text-blue-400">
                      <School className="w-5 h-5 flex-shrink-0" />
                      <span>Tour Hillcrest High School facilities</span>
                    </li>
                    <li className="flex items-center gap-3 text-blue-600 dark:text-blue-400">
                      <GraduationCap className="w-5 h-5 flex-shrink-0" />
